...
public class ScreenFader : MonoBehaviour
{
    ...
    // 화면 불투명도 관리 함수
    public void ScreenFadeHandler(bool isOpen)
    {
        // 현재 UI 상태와 같다면
        if (curState == isOpen)
            // 종료
    ...
    private void DebugOpen()
    {
        ...
        // 화면 불투명도 올릴 수 있게 현재 UI 상태를 변경
        curState = false;
        // 화면 불투명도 올리기
        ScreenFadeHandler(true);
    }
    ...
    private void DebugClose()
    {
        ...
        // 화면 불투명도 낮출 수 있게 현재 UI 상태를 변경
        curState = true;
        // 화면 불투명도 낮추기
        ScreenFadeHandler(false);
    }
}